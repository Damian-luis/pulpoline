      ...
      <div className="max-w-md w-full space-y-8 p-8 bg-gray-900 rounded-lg shadow-2xl border border-gray-800">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <button
                disabled={isSubmitting}
                type="submit"
                className="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:bg-gray-400 disabled:text-gray-200 disabled:cursor-not-allowed"
              >
